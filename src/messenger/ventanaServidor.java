...
public class ventanaServidor extends javax.swing.JFrame {
    ...
    public ventanaServidor() {
        ...
        try {
            ...
            while(true){
                Socket ventanaCliente = server.accept();
                mensajeria("Cliente conectado desde la dirección: "+ventanaCliente.getInetAddress().getHostAddress());
                        
                DataInputStream entrada = new DataInputStream(ventanaCliente.getInputStream());
                
                hiloServidor hilo = new hiloServidor (ventanaCliente, entrada.readUTF(), this);
                hilo.start();
    ...
    //Creación de nuestra clase mensajeria 
